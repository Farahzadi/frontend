          ...
          >
            <x.div display={"grid"} gridTemplateColumns={2} rowGap={5} columnGap={6} mb={5}>
              <NumberInput
                ...
                label={<x.span>Base Asset <x.a color={{_: "blue-gray-500", hover: "teal-200"}} target={"_blank"} href={zigZagChainId === 1 ? "https://zkscan.io/explorer/tokens" : "https://goerli.zkscan.io/explorer/tokens"}>Internal ID</x.a></x.span>}
                name={"baseAssetId"}
                validate={[
                  required,
                  min(0),
              ...
              <NumberInput
                ...
                label={<x.span>Quote Asset <x.a color={{_: "blue-gray-500", hover: "teal-200"}} target={"_blank"} href={zigZagChainId === 1 ? "https://zkscan.io/explorer/tokens" : "https://goerli.zkscan.io/explorer/tokens"}>Internal ID</x.a></x.span>}
                name={"quoteAssetId"}
                validate={[
                  required,
                  min(0),
